...
class SettingsTeacherPage extends StatefulWidget {
  Teacher teacher;
  UserService userService;
  SettingsTeacherPage({Key? key,required this.teacher,required this.userService}) : super(key: key);
  @override
  State<SettingsTeacherPage> createState() => _SettingsTeacherPageState();
}

class _SettingsTeacherPageState extends State<SettingsTeacherPage> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            const SizedBox(height: 20,),
            buildAccountRow(context, "Change Workplace","New Workplace",_newWorkplace,'workPlace'),
            const SizedBox(height: 20,),
            buildAccountRow(context, "Change Department","New Department",_newDepartment,'department'),
            const SizedBox(height: 20,),
        ...
        showDialog(context: context, builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [
              ...
              TextButton(onPressed: () {
                if(_formKey.currentState!.validate() && _currentPassword.text == widget.teacher.password){
                  widget.userService.ChangeUserPassword(_newPassword.text);
                  widget.userService.ChangeUserAttributes(_newPassword.text, 'password',userService.getTeachersCollection());
                  FirebaseAuth.instance.signOut();
        ...
        showDialog(context: context, builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [
              ...
              TextButton(onPressed: () {
                widget.userService.ChangeUserAttributes(textForm.text, choice,userService.getTeachersCollection());
                Navigator.of(context).pop();
              },
                child: const Text("Edit"),
              ),
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              TextButton(onPressed: () async {
                if( _currentPassword.text == widget.teacher.password){
                  await widget.userService.deleteUserDoc(widget.userService.getTeachersCollection());
